...
<div class="h-screen w-screen flex flex-col justify-between">
   <div class="flex items-center justify-between px-4 bg-gray-800 h-1/6" >
      ...
      <div class="flex items-center justify-center mx-auto">
        ...
        <button @click="makeRequest" class="px-4 py-1 bg-red-500 text-white rounded-r-lg">
          Recommend
        </button>
      </div>
    </div>
...
export default {
 ...
 <style>
 .bg-multiple-images-horizontal {
     background-image: url('/assets/harley.jpg'), url('/assets/blackwidow.jpg'), url('/assets/2001.jpg');
     background-position: left, center, right;
     background-repeat: no-repeat, no-repeat, no-repeat;
     background-size:contain,contain,contain;
   }
   .bg-multiple-images-vertical {
      background-image: url('/assets/harley.jpg'), url('/assets/blackwidow.jpg'), url('/assets/2001.jpg');
